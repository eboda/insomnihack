...
cd /usr/bin
for f in !(awk|base64|basename|clear|cmp|env|expr|find|id|head|groups|realpath|rev|seq|sort|split|sum|tee|tail|uniq|wc|which|touch|whoami|python3|python|python3.6)
do
